...
class SpotifiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spotify" do
    assert_difference("Spotify.count") do
      post spotifies_url, params: { spotify: { gmail: @spotify.gmail, password: @spotify.password } }
    end
  ...
  test "should update spotify" do
    patch spotify_url(@spotify), params: { spotify: { gmail: @spotify.gmail, password: @spotify.password } }
